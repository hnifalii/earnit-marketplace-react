            ...
            {data.data.map((product) => (
              <Link to={`/details/${product.id}`}>
                ...
                >
                  ...
                  <div className="flex flex-col h-screen max-h-[102px] justify-between">
                    <div className="px-2 py-2 rounded-b-md">
                      ...
                      <div className="flex items-center justify-between mt-[2px] text-[12px]">
                        ...
                        <span className="text-[12px] font-bold text-black">
                          <span className="text-[12px] font-medium text-black text-opacity-80">Mulai </span>Rp{product.attributes.price.toLocaleString("id-ID")}
                        </span>
                      </div>
                    </div>
